class FlavorsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @flavor.update(flavor_params)
        format.html { redirect_to @flavor, notice: "Flavor was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to flavors_path, notice: "Flavor was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_flavor
      @flavor = Flavor.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def flavor_params
      params.expect(flavor: [ :name, :color, :score ])
    end
end
